            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                >
                    ...
                    <h2 className="text-6xl md:text-8xl font-display font-black mb-6 tracking-tighter uppercase leading-none"
                        ...
                        Testing <br />
                        <span className="text-white/90">With User 1</span>
                    </h2>
                ...
                <div className="mb-12">
                    <div className="flex gap-2 p-1.5 bg-black/40 border border-white/5 rounded-xl w-fit">
                        <Link to="/user1" className="px-8 py-4 rounded-lg text-xs font-black tracking-widest uppercase transition-all bg-white/5 text-green-500 border border-green-500/30 shadow-[0_0_20px_rgba(16,185,129,0.15)]">
                            User 1
                        </Link>
                        <Link to="/user2" className="px-8 py-4 rounded-lg text-xs font-black tracking-widest uppercase transition-all text-slate-500 hover:text-yellow-500 hover:bg-white/5">
                            User 2
                        </Link>
